...
### Bug Fixes
- Fixed support for dual headed accounts that share the same UPN for both, an MSA and an AAD accounts. See [4425](https://github.com/AzureAD/microsoft-authentication-library-for-dotnet/issues/4425).
