---
skill_name: msal-confidential-obo-flow
version: 1.0
description: Guidance for On-Behalf-Of (OBO) Flow in MSAL.NET confidential client applications. Use for multi-tier web APIs acting on behalf of authenticated users, AcquireTokenOnBehalfOf, or propagating user context through a service chain.
applies_to:
