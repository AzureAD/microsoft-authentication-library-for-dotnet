---
skill_name: msal-confidential-auth-code-flow
version: 1.0
description: Guidance for Authorization Code Flow in MSAL.NET confidential client applications. Use for web app user sign-in, AcquireTokenByAuthorizationCode, or confidential client auth code flow scenarios.
applies_to:
