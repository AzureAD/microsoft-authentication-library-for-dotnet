...
namespace Microsoft.Identity.Test.Unit
{
    internal static class TestConstants
    {
        ...
        public const string AuthoritySovereignCNCommon = "https://" + SovereignNetworkEnvironmentDE + "/" + Common + "/";
        ...
        public const string B2CCustomDomain = "https://" + CatsAreAwesome + ".com/tfp/" + CatsAreAwesome + "/" + B2CSignUpSignIn + "/";
