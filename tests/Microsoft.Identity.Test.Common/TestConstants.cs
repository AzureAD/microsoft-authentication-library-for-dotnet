        ...
        public const string AndroidBrokerResponse = @"
{
   ...
   ""backchannel_user_code_parameter_supported"":true
        ...
        /// </summary>
        internal const string ExpiredRawCertificate = "";

        // 20-year valid certificate (valid from 2025-10-03 02:55:47Z UTC → 2045-09-28 02:55:47Z UTC)
        internal const string ValidRawCertificate = "";

        // Matching RSA private key (XML RSAKeyValue). Works for both certs.
        internal const string XmlPrivateKey = @"<RSAKeyValue>
  <Modulus></Modulus>
  <Exponent>AQAB</Exponent>
  <P>7MjQHM3+E95OUXRsUd8g/Y3LZysBvUqBTEODzlnpVceRIb44cCOYp8yF2PhcycQq6y017SDKVqyYk/IxCtWCRu8+KaN0rxb8bzPsLrw4xwlqEFTGm73uHd/uez+4WVp2de67QD5UAtfmCry1YL4NEwlX0p/+voO6+Yb9pQJFPKk=</P>
  <Q>wCIT1qR34cvld8QHccbE91e0e49a9dxB0xzwniEbQelfYh/T8QcIH+FHv7HM/VAFEKPg9VwtmaKDpBv4DpuluLIlQ+VlhL0u8rOy+pyUutK7uj+80BhrJxcS4ukH8YjebDGtBDqAeyTOhhY+XrtkQnbSvhcUoVjv5225AyCKE3E=</Q>
  <DP>DV1MOcP6qj5q5zgOART59LWzHFCWGYwB/j71SolSnS/VZjUpVFL+A8KMb3GdMxoqXfnASHEIWpoFRpxt3jGs17obJRh/tn4yo0gn9X9UKQ/D98YBK7stnGwONtCi5BAyDXf7A6ZA8aQj7Mk354zyifeGCHJVW4Vt4TWYTV7yb3k=</DP>
  <DQ>v6A9URLwTk/iKbVmB2BMCrV62NF900E+laSDh/NVEEQGUgOUiwyMWd+Cg/p9jRhGNPZ947lv8Y9Y5FDQ8yDiBHgJGtKskdtt+7qmg7Wv0TVk7rmrQ5FXLcGhoJbyyT/NNvPEsDb49dkb8jg1NJ6JvJBuWBEFDnd5rsSMhkXp8ME=</DQ>
  <InverseQ>uG9n2qHtvitWojKmyfZ6+CEdIqcOVbeQrMKm5btrM9wrTwzN0o8RwWJHkhW7jzJmocuhPZ6xsmf/w2PafHCsrrlSe8PH9/A3aFHmt31/TeE6+LIQhR5I2Iim95TqYhuEj7rm0SAJL2pYujYeVhGO35oODyXaNxg/mwBvqz0tAPA=</InverseQ>
  <D></D>
</RSAKeyValue>";
        #endregion
    }
