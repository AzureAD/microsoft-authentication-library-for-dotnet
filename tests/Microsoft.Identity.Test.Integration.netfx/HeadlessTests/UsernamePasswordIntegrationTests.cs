...
namespace Microsoft.Identity.Test.Integration.HeadlessTests
{
    ...
    public class UsernamePasswordIntegrationTests
    {
        ...
        private readonly string XClientCurrentTelemetryROPC = $"{TelemetryConstants.HttpTelemetrySchemaVersion}|1003,{CacheMissReason.NotApplicable:D},,,|0,1";
        private readonly string XClientCurrentTelemetryROPCFailure = $"{TelemetryConstants.HttpTelemetrySchemaVersion}|1003,{CacheMissReason.NotApplicable:D},,,|0,1";
