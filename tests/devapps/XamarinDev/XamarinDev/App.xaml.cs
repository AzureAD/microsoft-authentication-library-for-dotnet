...
namespace XamarinDev
{
    public partial class App : Application
    {
            ...
            get
            {
                switch (Device.RuntimePlatform)
                {
                    ...
                    case Device.Android:
                        ...
                        return "msauth://YourBrokerRedirectUri";
#else
        ...
        public const string B2CEditProfilePolicyAuthority = "https://msidlabb2c.b2clogin.com/tfp/msidlabb2c.onmicrosoft.com/B2C_1_ProfileEditPolicy/oauth2/v2.0/authorize";
