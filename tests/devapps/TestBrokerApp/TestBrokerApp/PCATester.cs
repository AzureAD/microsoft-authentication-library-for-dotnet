...
#if NET48 || NETCOREAPP3_1 // This for classic net and net core
            WindowsBrokerOptions wbo = new WindowsBrokerOptions();
            wbo.MsaPassthrough = HasMsaPasThrough;
            wbo.HeaderText = "Windows Broker Header";
            wbo.ListWindowsWorkAndSchoolAccounts = ListOSAccounts;
            pcaBuilder.WithWindowsBrokerOptions(wbo);
...
#else // for other platforms not including UWP and MAUI. Those are seperate projects.
