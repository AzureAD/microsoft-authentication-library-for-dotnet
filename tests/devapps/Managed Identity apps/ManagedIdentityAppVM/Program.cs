...
internal class Program
{
    ...
    // Session flags
    private static bool s_forceRefresh = false;
    private static bool s_lastWasBound = false;
    private static bool s_hasLast = false;

    // NEW: Toggle for full token printing (default OFF)
    ...
    private static async Task Main()
    {
        ...
        while (true)
        {
            ...
            Console.Write("\nChoice (A/P/T/F/I/R/H/Enter/X): ");
            var key = Console.ReadKey(intercept: true);

            if (key.Key == ConsoleKey.Enter)
            {
                if (!s_hasLast)
                { Info("No previous acquisition yet. Press A or P first."); continue; }
    ...
    private static void DrawStatusBar()
    {
        ...
        Console.WriteLine($"Mode     : {(s_lastWasBound ? "Bound (mTLS PoP)" : "Bearer")}, ForceRefresh={(s_forceRefresh ? "ON" : "OFF")}");
    ...
    private static void WriteMenu()
    {
        ...
        Console.WriteLine("T) Toggle Force Refresh");
        Console.WriteLine("F) Toggle Full Token Print  <-- NEW");
    ...
    private static void PrintHelp()
    {
        ...
        Console.WriteLine(" - T: Toggle Force Refresh to bypass cache on next acquisition.");
