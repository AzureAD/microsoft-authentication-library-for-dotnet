...
namespace Microsoft.Identity.Test.Unit.MatsTests
{
    ...
    public class ContextStoreTests : AbstractMatsTest
    {
        ...
        public void AddContextCorrectlyAddsFieldsToPropertyBagContents()
        {
            ...
            var contextStore = ContextStore.CreateContextStore(AudienceType.PreProduction, "AppName", "1.0", "deviceId", "deviceNetworkState", sessionId, 1);
            ...
            Assert.AreEqual(MatsConverter.AsString(AudienceType.PreProduction), contentsWithContext.StringProperties[ContextPropertyNames.AppAudienceConstStrKey]);
