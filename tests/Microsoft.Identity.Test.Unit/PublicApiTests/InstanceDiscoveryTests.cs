...
namespace Microsoft.Identity.Test.Unit.PublicApiTests
{
    ...
    public class InstanceDiscoveryTests : TestBase
    {
        ...
        public async Task NoInstanceDiscovery_AirgappedCould_TestAsync(bool validateAuthority)
        {
            using (var httpManager = new MockHttpManager())
            {
                ...
                var app = ConfidentialClientApplicationBuilder.Create(TestConstants.ClientId)
                                                              .WithAuthority(TestConstants.AuthorityNotKnownTenanted, validateAuthority)
                                                              .WithClientSecret(TestConstants.ClientSecret)
                                                              .WithHttpManager(httpManager)
