...
namespace Microsoft.Identity.Test.Unit.ManagedIdentityTests
{
    ...
    public class CredentialTests : TestBase
    {
        ...
        /// <summary>
        /// Tests the happy path for acquiring credentials with KeyGuard Key.
        /// </summary>
        [TestMethod]
        ...
        /// </summary>
        [TestMethod]
        public async Task CredentialWithClaimsWorksWithUserKeysAsync()
        {
            // Arrange
            using (MockHttpAndServiceBundle harness = CreateTestHarness())
            using (var httpManager = new MockHttpManager(isManagedIdentity: true))
        ...
        public async Task ManagedIdentityCacheTestAsync()
        {
            ...
            using (var httpManager = new MockHttpManager(isManagedIdentity: true))
            {
                ...
                var appTokenCacheRecoder = mi.AppTokenCacheInternal.RecordAccess((args) =>
                {
                    ...
                    Assert.AreEqual(TestConstants.CredentialIdentityDefaultClientId, args.ClientId);
