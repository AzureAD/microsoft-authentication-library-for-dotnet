...
namespace Microsoft.Identity.Test.Unit.ManagedIdentityTests
{
    ...
    public class ManagedIdentityTests : TestBase
    {
        ...
        [DataRow(ImdsEndpoint, ManagedIdentitySource.Credential, ManagedIdentitySource.Credential)]
        [DataRow(null, ManagedIdentitySource.Credential, ManagedIdentitySource.Credential)]
        ...
        [DataRow(ImdsEndpoint, Resource, ManagedIdentitySource.Credential)]
        [DataRow(null, Resource, ManagedIdentitySource.Credential)]
        ...
        [DataRow(ImdsEndpoint, ManagedIdentitySource.Credential, TestConstants.ClientId, UserAssignedIdentityId.ClientId)]
        [DataRow(ImdsEndpoint, ManagedIdentitySource.Credential, TestConstants.MiResourceId, UserAssignedIdentityId.ResourceId)]
        [DataRow(ImdsEndpoint, ManagedIdentitySource.Credential, TestConstants.MiResourceId, UserAssignedIdentityId.ObjectId)]
        ...
        [DataRow(ImdsEndpoint, Resource, "https://graph.microsoft.com", ManagedIdentitySource.Credential)]
        ...
        [DataRow("user.read", ManagedIdentitySource.Credential, ImdsEndpoint)]
        [DataRow("https://management.core.windows.net//user_impersonation", ManagedIdentitySource.Credential, ImdsEndpoint)]
        [DataRow("s", ManagedIdentitySource.Credential, ImdsEndpoint)]
        ...
        [DataTestMethod]
        [DataRow(ManagedIdentitySource.AppService, AppServiceEndpoint)]
        [DataRow(ManagedIdentitySource.Credential, ImdsEndpoint)]
        ...
        [DataRow(ManagedIdentitySource.Credential, ImdsEndpoint, HttpStatusCode.NotFound)]
