...
namespace Microsoft.Identity.Test.Unit.ManagedIdentityTests
{
    ...
    internal static class CsrValidator
    {
        ...
        public static void ValidateCsrContent(string rawCsr, string expectedClientId, string expectedTenantId, CuidInfo expectedCuid)
        {
            ...
            StringAssert.Contains(subjectString, $"CN={expectedClientId}", "Client ID (CN) not found in subject");
            StringAssert.Contains(subjectString, $"DC={expectedTenantId}", "Tenant ID (DC) not found in subject");
