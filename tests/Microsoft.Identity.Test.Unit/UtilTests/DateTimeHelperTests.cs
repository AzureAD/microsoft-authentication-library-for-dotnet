...
namespace Microsoft.Identity.Test.Unit.UtilTests
{
    ...
    public class DateTimeHelperTests
    {
        ...
        public void TestGetDurationFromNowInSecondsForUnixTimestampOnly()
        {
            ...
            Assert.IsGreaterThanOrEqualTo(result, 0, "Valid Unix timestamp (seconds) failed");
            ...
            Assert.IsGreaterThan(result, 0, "Future Unix timestamp failed");
            ...
            Assert.IsLessThan(result, 0, "Past Unix timestamp failed");
        ...
        public void TestGetDurationFromNowInSecondsFromManagedIdentity()
        {
            ...
            Assert.IsGreaterThanOrEqualTo(result, 0, "Unix timestamp (seconds) failed");
            ...
            Assert.IsGreaterThanOrEqualTo(result, 0, "ISO 8601 failed");
            ...
            Assert.IsGreaterThanOrEqualTo(result, 0, "Common Format 1 failed");
            ...
            Assert.IsGreaterThanOrEqualTo(result, 0, "Common Format 2 failed");
