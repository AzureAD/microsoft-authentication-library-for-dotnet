...
namespace Microsoft.IdentityModel.Clients.ActiveDirectory
{
    internal static partial class OAuth2Request
    {
        ...
        private static Uri CreateAuthorizationUri(Authenticator authenticator, string resource, Uri redirectUri, string clientId, string userId, string extraQueryParameters, CallState callState)
        {
            RequestParameters requestParameters = OAuth2MessageHelper.CreateAuthorizationRequest(resource, clientId, redirectUri, userId, extraQueryParameters, callState);
