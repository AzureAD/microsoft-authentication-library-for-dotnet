            ...
            this.Messages = new Dictionary<int, string>
                {
                    ...
                    { (int)NavigateErrorStatusCode.HTTP_STATUS_NOT_FOUND, "The server has not found anything matching the requested URI (Uniform Scope Identifier)." },
                    ...
                    { (int)NavigateErrorStatusCode.HTTP_STATUS_URI_TOO_LONG, "The server is refusing to service the request because the request URI (Uniform Scope Identifier) is longer than the server is willing to interpret." },
