...
namespace Microsoft.Identity.Client.Platforms.net45.Native
{
    ...
    internal sealed class RSACng : RSA, ICngAsymmetricAlgorithm // TODO: bogavril - move to PCA
    {
        ...
        ///     property, using ImportParameters to create a new key, or by Disposing of the parent RSA object.
