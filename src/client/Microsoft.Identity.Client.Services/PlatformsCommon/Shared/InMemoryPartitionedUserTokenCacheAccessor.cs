...
namespace Microsoft.Identity.Client.PlatformsCommon.Shared
{
    ...
    internal class InMemoryPartitionedUserTokenCacheAccessor : ITokenCacheAccessor
    {
        ...
        public void DeleteRefreshToken(MsalRefreshTokenCacheItem item)
        {
            ...
            {
                _logger.InfoPii(
                    $"[Internal cache] Cannot delete refresh token because it was not found in the cache. Key {item.GetKey()}.",
        ...
        public void DeleteIdToken(MsalIdTokenCacheItem item)
        {
            ...
            {
                _logger.InfoPii(
                    $"[Internal cache] Cannot delete ID token because it was not found in the cache. Key {item.GetKey()}.",
