...
namespace Microsoft.Identity.Client
{
    ...
    internal static class MsalErrorMessage
    {
        ...
        public const string BrokerAndSsoPolicyConfigurationError = "WithBroker and WithSsoPolicy cannot be used together. Broker by default supports SsoPolicy. Use WithSsoPolicy only when using embedded webview";
