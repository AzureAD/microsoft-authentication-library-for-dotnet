...
namespace Microsoft.Identity.Client
{
    ...
    internal static class MsalErrorMessage
    {
        ...
        public const string B2cConfiguredForBrokerPop = "The request has Proof-of-Possession configured but B2C is configured. Broker is required for Proof-of-Possession but it does not support B2C. Please use IPublicCleintApplication.IsProofOfPosessionSupportedByClient to ensure Proof-of-Possession can be performed before using WithProofOfPossession.";
        public const string BrokerUsedOnNonWindowsOsPop = "The request has Proof-of-Possession configured but is not running on a broker supported operating system. Broker is required for Proof-of-Possession. Please use IPublicCleintApplication.IsProofOfPosessionSupportedByClient to ensure Proof-of-Possession can be performed before using WithProofOfPossession.";
