...
namespace Microsoft.Identity.Client
{
    ...
    internal static class MsalErrorMessage
    {
        ...
        public const string ManagedIdentityUserAssignedNotConfigurableAtRuntime = "[Managed Identity] Service Fabric only supports object ID for specifying a managed identity. ClientId and ResourceId are not supported. Use ManagedIdentityId.WithUserAssignedObjectId() instead.";
