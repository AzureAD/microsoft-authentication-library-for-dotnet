...
namespace Microsoft.Identity.Client
{
    ...
    internal static class MsalErrorMessage
    {
        ...
        public const string ParsingWsTrustResponseFailedErrorTemplate = "Federated service at {0} parse error. Enable logging to see more details. See https://aka.ms/msal-net-logging.";
