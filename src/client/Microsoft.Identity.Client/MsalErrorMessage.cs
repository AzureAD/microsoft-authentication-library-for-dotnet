...
namespace Microsoft.Identity.Client
{
    ...
    internal static class MsalErrorMessage
    {
        ...
        public const string BrokerDoesNotSupportPop = "The broker doe snot support pop on the current platform.";
        public const string BrokerRequiredForPop = "The request has proof of possesion configured but does not have broker enabled. Broker is required for proof of possesion on public clients";
