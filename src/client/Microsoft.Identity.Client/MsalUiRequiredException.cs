...
namespace Microsoft.Identity.Client
{
    ...
    public class MsalUiRequiredException(string errorCode, string errorMessage, Exception innerException, UiRequiredExceptionClassification classification) : MsalServiceException(errorCode, errorMessage, innerException)
    {
        private readonly UiRequiredExceptionClassification _classification = classification;
