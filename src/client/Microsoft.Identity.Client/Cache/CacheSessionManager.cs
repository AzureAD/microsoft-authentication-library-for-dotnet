...
namespace Microsoft.Identity.Client.Cache
{
    ...
    internal class CacheSessionManager : ICacheSessionManager
    {
        ...
        public async Task<IDictionary<string, TenantProfile>> GetTenantProfilesAsync(string homeAccountId) => await TokenCacheInternal.GetTenantProfilesAsync(_requestParams, homeAccountId).ConfigureAwait(false);
