...
namespace Microsoft.Identity.Client
{
    ...
    public sealed partial class PublicClientApplication : ClientApplicationBase, IPublicClientApplication, IByRefreshToken
    {
        ...
        /// <item><description>In .NET 8 or later apps, target the corresponding Windows TFM (for example, <c>net10.0-windows10.0.17763.0</c>) for all Windows versions and the platform-neutral TFM for Linux and Mac.</description></item>
