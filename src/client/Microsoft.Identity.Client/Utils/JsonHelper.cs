...
namespace Microsoft.Identity.Client.Utils
{
    ...
    {
        internal static string SerializeNew<T>(T toEncode) where T : IJsonSerializable<T>
        {
            return toEncode?.SerializeToJson() ?? string.Empty;
        }

        internal static T DeserializeNew<T>(string json) where T : IJsonSerializable<T>, new()
        {
            ...
            return new T().DeserializeFromJson(json);
        }
