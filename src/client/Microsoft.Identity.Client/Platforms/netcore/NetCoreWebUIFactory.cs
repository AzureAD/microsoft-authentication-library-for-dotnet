            ...
            RequestContext requestContext)
        {
            if (webViewPreference == WebViewPreference.Embedded)
            {
                throw new MsalClientException(MsalError.WebviewUnavailable,
                    ...
                    "If you have a cross-platform (Windows, Mac, Linux) application which targets net6, please dual target net6 and net6-windows10.0.17763.0." + 
                        "Your installer should deploy the net6 version on Mac and Linux and the net6-window10.0.17763.0 on Win7 - Win10." + 
