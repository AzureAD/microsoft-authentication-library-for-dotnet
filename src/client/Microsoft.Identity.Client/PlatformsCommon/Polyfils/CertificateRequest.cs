...
namespace Microsoft.Identity.Client.PlatformsCommon.Polyfils
{
    // This exists in net8+ but we are using a polifyl 
    // TODO: evaluate using the net8+ version directly
