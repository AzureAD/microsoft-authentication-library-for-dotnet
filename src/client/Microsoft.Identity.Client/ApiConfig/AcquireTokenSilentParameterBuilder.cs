...
namespace Microsoft.Identity.Client
{
        ...
        AbstractClientAppBaseAcquireTokenParameterBuilder<AcquireTokenSilentParameterBuilder>
    {
        ...
        /// </list>
        /// </remarks>
        public AcquireTokenSilentParameterBuilder WithPoPAuthenticationScheme(HttpRequestMessage httpRequestMessage)
        {
        ...
        internal AcquireTokenSilentParameterBuilder WithPoPAuthenticationScheme(HttpRequestMessage httpRequestMessage, IPoPCryptoProvider popCryptoProvider)
        {
