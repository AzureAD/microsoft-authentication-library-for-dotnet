...
namespace Microsoft.Identity.Client
{
        ...
        AbstractManagedIdentityAcquireTokenParameterBuilder<AcquireTokenForManagedIdentityParameterBuilder>
    {
        ...
        /// <summary>
        /// Acquires proof of possession (PoP) tokens for managed identity.
        /// </summary>
        /// <returns></returns>
        public AcquireTokenForManagedIdentityParameterBuilder WithProofOfPossession()
        {
            ValidateUseOfExperimentalFeature();
            CommonParameters.UseMtlsPop = true;
            return this;
        }
