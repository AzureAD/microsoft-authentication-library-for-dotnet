...
namespace Microsoft.Identity.Client
{
    ...
    public class MsalException : Exception
    {
        ...
        internal bool Retry { set; private get; }
        ...
        public MsalException(string errorCode, bool retry = false)
        {
            ErrorCode = errorCode;
        }
        ...
        /// <param name="retry">The boolean to indicate whether to perform retry operation for the exception.</param>
        public MsalException(string errorCode, string errorMessage, bool retry = false)
            : base(errorMessage)
        {
        ...
        /// </param>
        /// <param name="retry">The boolean to indicate whether to perform retry operation for the exception.</param>
        public MsalException(string errorCode, string errorMessage, Exception innerException, bool retry = false)
