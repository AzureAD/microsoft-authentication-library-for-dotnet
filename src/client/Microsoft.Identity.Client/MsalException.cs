...
namespace Microsoft.Identity.Client
{
    ...
    public class MsalException : Exception
    {
        ...
        public MsalException(string errorCode, bool isRetryable = false)
        {
            ErrorCode = errorCode;
        ...
        /// <param name="isRetryable">The boolean to indicate whether to perform retry operation for the exception.</param>
        public MsalException(string errorCode, string errorMessage, bool isRetryable = false)
            : base(errorMessage)
        {
        ...
        /// </param>
        /// <param name="isRetryable">The boolean to indicate whether to perform retry operation for the exception.</param>
        public MsalException(string errorCode, string errorMessage, Exception innerException, bool isRetryable = false)
        ...
        public static MsalException FromJsonString(string json)
        {
            ...
            if (s_typeNameToType.Value.TryGetValue(type, out Type exceptionType))
            {
                ...
                MsalException ex = Activator.CreateInstance(exceptionType, errorCode, errorMessage, false) as MsalException;
