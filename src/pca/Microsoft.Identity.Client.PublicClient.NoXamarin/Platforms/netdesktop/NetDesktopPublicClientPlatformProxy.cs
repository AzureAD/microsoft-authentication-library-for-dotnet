...
namespace Microsoft.Identity.Client.Platforms.net45
{
    ...
    /// </summary>
    internal class NetDesktopPublicClientPlatformProxy : NetDesktopPlatformProxy, IPublicClientPlatformProxy
    {
        /// <inheritdoc />
        public NetDesktopPublicClientPlatformProxy(ICoreLogger logger)
            : base(logger)
        {
        }
        ...
        public bool UseEmbeddedWebViewDefault => true;
