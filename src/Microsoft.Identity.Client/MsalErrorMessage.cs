...
namespace Microsoft.Identity.Client
{
    ...
    internal static class MsalErrorMessage
    {
        ...
        public const string ClientSecretAndCertificateAreMutuallyExclusive = "ClientSecret, Certificate and ClientAssertion are mutually exclusive properties.  Only specify one.";
