...
- 
- There is also a prerelease version of the library avialable on the [NuGet gallery](https://www.nuget.org/packages/Microsoft.IdentityModel.Clients.ActiveDirectory/).
- 
