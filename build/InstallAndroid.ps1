...
try 
{
    ...
    Copy-Item -Path microsoft-authentication-library-for-dotnet\build\AndroidSdkLicense -Destination "C:\Program Files (x86)\Android\android-sdk\licenses" -Filter * -Force
